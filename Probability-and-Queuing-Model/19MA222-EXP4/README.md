# Experiment-04: Single server with infinite capacity (M/M/1):(∞/FIFO)
...
<img width="277" height="39" alt="image" src="https://github.com/user-attachments/assets/06c84260-8774-41c1-9968-7507ea0d3664" />

This is a queuing model in which the arrival is Marcovian and departure distribution is also Marcovian,number of server is one and size of the queue is also Marcovian,no.of server is one and size of the queue is infinite and service discipline is 1st come 1st serve(FCFS) and the calling source is also finite.

## Procedure :

<img width="481" height="242" alt="image" src="https://github.com/user-attachments/assets/c4796d3d-c0c7-4fa1-8e9f-bdbb76c9504c" />
