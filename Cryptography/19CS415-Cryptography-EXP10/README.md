...
long long int mod_exp(long long int base, long long int exp,
                      long long int mod) {
...
int main() {
  ...
  if (ka == kb) {
    printf("\nDiffie-Hellman Key Exchange successful. Both parties share the "
           "same key.\n");
  } else {
...
<img width="806" height="430" alt="image" src="https://github.com/user-attachments/assets/45cf799c-4979-49f6-a31e-f0591e2d3b87" />
