...
To write a Java program to implement wrapper class using java.
...
```
/*
Program to implement Wrapper Class using Java
...
Thus the Java program to implement wrapper class using java was executed successfully.